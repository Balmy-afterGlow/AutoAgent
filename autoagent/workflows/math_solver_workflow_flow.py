...
async def solve_with_gpt4(event: EventInput, global_ctx):
    ...
    outputs = [
        {
            "key": "gpt4_solution",
            "description": "The solution generated by GPT-4 model.",
            "condition": None,
    ...
    response: Response = await client.run_async(
        agent=agent, messages=messages, context_variables=global_ctx, debug=True
    )
...
async def solve_with_claude(event: EventInput, global_ctx):
    ...
    outputs = [
        {
            "key": "claude_solution",
            "description": "The solution generated by Claude model.",
            "condition": None,
            "action": {"type": "RESULT", "value": None},
        }
    ]
    ...
    outputs = [
        {
            ...
            "description": "The solution generated by Deepseek model.",
            "condition": None,
            "action": {"type": "RESULT", "value": None},
        }
    ]
...
async def aggregate_solutions(event: EventInput, global_ctx):
    ...
    messages = global_ctx.get("messages", [])
    task = (
        "Compare all solutions and determine the final answer through majority voting."
    )
    outputs = [
        {
            "key": "final_solution",
            "description": "The final agreed-upon solution after majority voting.",
            "condition": None,
            "action": {"type": "RESULT", "value": None},
        }
    ]
